    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <form action="input_setoran.php" method="post" class="form-horizontal">
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-success pull-right" style="margin-right:9%;">Simpan</button>
